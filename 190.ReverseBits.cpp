...
/*
    ...
    Note:
        ...
        as a signed integer type. They should not affect your implementation,
...
int main()
{
    ...
    assert(964176192U == s.reverseBits(43261596U));

    assert(3221225471U == s.reverseBits(4294967293U));
